...
const client = makeWASocket({ logger: pino ({ level: 'silent' }), printQRInTerminal: true, auth: state, browser: ["SC Simple By Vinss", "Dekstop", "3.0"]})
console.log(color('[ SC BY VINSS OFC  ]\n', 'red'),color('\nInfo Script :\n➸ Baileys : Multi Device\n➸ Nama Script : PUSHKONTAK\n➸ Creator : VINSS OFC\n\nFollow My Social Media Account All Yes :\n➸ My Youtube : VINSS OFC`\n➸ My Instagram : @kahfiofc\n\nDonase Me For Support :\n➸ DONASI : https://saweria.co/MaxxyBotz\n\nThanks\n', 'red'))
